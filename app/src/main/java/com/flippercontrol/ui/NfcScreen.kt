...
fun NfcScreen(
    ...
    var tab by remember { mutableIntStateOf(0) }  // 0=Read 1=Library 2=Emulate
            ...
            0 -> NfcReadTab(
                ...
                onStartRead = {
                    scope.launch {
                        ...
                        // RPC: запуск NFC read
                        // session.sendAndReceive(PbFieldId.NFC_READ, byteArrayOf())
                    }
                },
                onStopRead = {
                    isReading = false
            ...
            2 -> NfcEmulateTab(
                ...
                onToggleEmulate = {
                    scope.launch {
                        ...
                        // session.nfcEmulateCard(selectedCard)
                    }
                },
                onBack = { tab = 1 }
            )
